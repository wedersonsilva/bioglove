...
%	\end{figure}
		...
		No trabalho de \cite{michela2013rehab} o microcontrolador HC9S08QB8, da fabricante Freescale, foi utilizado para diminuir a complexidade de transmissão, além de consumir pouca energia. Já em \cite{anbarasi2013deafmute}, a saída de texto do microcontrolador ATmega 328 é convertida em voz pelo chip TTS256.
		...
		No trabalho proposto, a placa Arduino modelo Nano com o microcontrolador ATmega328, é utilizada para receber os sinais dos transdutores, converter sinais analógicos em digitais, codificar os sinais e enviá-los. A figura \ref{Fig:arduino-nano1} mostra a placa utilizada no projeto.
		...
		O modo de transmissão do sinal adquirido e processado pelo microcontrolador que deve chegar até a aplicação é de escolha do pesquisador. Em \cite{solanki2013sign}, usando fios, a saída de texto do microcontrolador é mostrada em uma pequena tela de LCD. No trabalho de \cite{syed2012armcontroller} os fios conectam o microcontrolador diretamente à servomotores que controlam um braço robótico.
