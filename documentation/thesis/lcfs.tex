...
%		\end{figure}
	...
	\end{table}
		...
		Como foi explicado anteriormente, a mensagem transmitida pela luva consiste em conjunto de 5 dígitos no qual cada um deles indica posições de cada dedo. Usando o lado esquerdo como referência, o primeiro dígito indica a posição do dedo 1, que é o dedo mínimo. O segundo dígito indica a posição do dedo 2, ou seja, o dedo anelar. Essa lógica segue até o quinto dígito que representa a posição do dedo polegar.
		...
		\begin{figure}[h!]
			\centering
			\caption{Combinação de flexões e extensões para controle do carrinho}
