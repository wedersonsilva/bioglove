...
%+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
	...
	\end{figure}
		...
		Para facilitar a abordagem do trabalho, cada dedo da luva e seu respectivo potenciômetro é representado por um número de 1 a 5, começando pelo dedo mínimo (1) até o polegar (5). Também foram definidas duas posições principais para o movimento dos dedos. Posição 1: Quando todos os dedos estiverem estendidos. Posição 2: Quando todos os dedos estiverem flexionados. Essas duas posições foram demonstradas na figura \ref{Fig:glove-flex-and-extend2}. 
