...
\chapter{Introdução} % ou \input{arquivoexterno}
	...
	\begin{figure}[!h]
		...
		\includegraphics[width=12cm,keepaspectratio=true]{./figures/flex-sensor-sparkfun.png}
		\fonte{Site Sparkfun}%
	...
	\end{figure}
		...
		\begin{figure}[h!]
			\centering
  		\includegraphics[scale=0.5]{./figures/hand-flex-movement1.png}
	...
	\chapter{Trabalho Propriamente Dito}
		...
		\begin{figure}[h!]
			\centering
  		\includegraphics[scale=0.7]{./figures/hand-flex1.png}
		...
		\begin{figure}[h!]
			\centering
  		\includegraphics[scale=0.8]{./figures/receptor-to-app1.png}
		...
		\begin{figure}[h!]
			\centering
  		\includegraphics[scale=0.5]{figures/size-glove-module-tx1.png}
